...
> [!WARNING]
> **This is an alpha release (v1.2.2a7).** Features may change. Not recommended for production.
...
- Current version: **v1.2.2a7** (Stable)
...
| [docs/stable/](docs/stable/) | Docs for **v1.2.2a7 stable** |
| [docs/dev/](docs/dev/) | Docs for **v1.2.2a7** (current) |
