...
The API (`nolqu.h`) is **identical** across all 1.x releases — there are no breaking
changes to `nq_open`, `nq_close`, `nq_dostring`, `nq_dofile`, `nq_register`, etc.
